...
const THEMES: ThemePreview[] = [
  ...
  },
  {
    key: "kimi-earth",
    label: "Kimi Earth",
    note: "Warm parchment, terracotta, serif — Kimi's ceramics store",
    bg: "#f5f2e9",
    surface: "#faf8f2",
    fg: "#2d2922",
    muted: "#8a8072",
  ...
  },
  {
    key: "kimi-cocoa",
    label: "Kimi Cocoa",
    note: "Chocolate luxury, caramel gold — Kimi's Cocoa Hills",
    bg: "#f5f0e8",
    surface: "#ffffff",
    fg: "#2c2218",
    muted: "#7d6e5e",
  ...
  },
  {
    ...
    note: "Sharp monochrome, high contrast — Kimi's editorial reader",
    bg: "#ffffff",
    surface: "#fafafa",
    fg: "#141414",
    muted: "#5c5a54",
  ...
  },
  {
    key: "kimi-terminal",
    label: "Kimi Terminal",
    note: "Data-dense, amber accents — Kimi's GMT://TERMINAL",
    bg: "#f4f6f8",
    surface: "#ffffff",
    fg: "#16181d",
    muted: "#5d6470",
